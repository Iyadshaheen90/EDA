...
public class NewLibraryController {
    ...
    public void create() {
        ...
        } else if(!file.isDirectory()) { // Checks to make sure file is directory
            file = file.getParentFile(); // Gets parent if it is a file
        } else {
//      TODO: Move this part to other function duplicated in HomeController
            Global.setLibraryLoc(file.getAbsolutePath());
